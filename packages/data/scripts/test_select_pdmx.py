...
class SelectionTests(unittest.TestCase):
    def test_quality_filters(self):
        ...
        for key, value in [('license_conflict', 'True'), ('is_draft', 'True'), ('has_paywall', 'True'), ('has_lyrics', 'True'), ('rating', '4.4'), ('n_ratings', '4'), ('n_tracks', '1'), ('n_notes', '99'), ('composer_name', 'unknown')]:
    ...
    def test_safe_extraction_and_metadata_deduplication(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            valid = row()
            rows = [valid, {**valid, 'mid': './mid/duplicate.mid'}, {**valid, 'song_name': 'Symlink', 'mid': './mid/link.mid', 'metadata': './metadata/124.json'}, {**valid, 'song_name': 'Escape', 'mid': '../escape.mid', 'metadata': './metadata/125.json'}, {**valid, 'song_name': 'Malformed', 'rating': 'n/a'}]
